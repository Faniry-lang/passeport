(function () {
    ...
    async function rechercher() {
        ...
        const url = `/demandes/transfert/recherche?idDemande=${encodeURIComponent(idDemande)}`;
        ...
        setField("visaReference", d.visaReference);
        setField("passeportActuel", d.passeportNumero);
